...
LABEL org.opencontainers.image.authors="Torben Weibert" \
      ...
      org.opencontainers.image.documentation="https://github.com/mdisabato/streammonitor-d" \
      org.opencontainers.image.base.name="docker.io/library/node:18-alpine" \
      org.opencontainers.image.licenses="AGPL-3.0" \
      org.opencontainers.image.source="https://github.com/mdisabato/streammonitor-d" \
      org.opencontainers.image.vendor="Common Frequency Inc" \
      org.opencontainers.image.version="0.0.2" \
      org.opencontainers.image.url="https://github.com/mdisabato/streammonitor-d"
